...
export class CharacterManager {
  ...
  private disposeFaceGroup(): void {
    ...
    this.faceGroup.removeFromParent()
    this.proceduralMeshes = this.proceduralMeshes.filter((m) => !removed.has(m))
    this.faceGroup = null
  }
